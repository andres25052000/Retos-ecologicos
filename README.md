...
La aplicación también incluye una sección para la adquisición de productos ecológicos. Cada compra muestra información sobre cómo contribuye al cuidado del medio ambiente, indicando el impacto positivo generado, como la reducción de residuos o el ahorro de recursos naturales..

Autor(es): Maria Paula Rodriguez y Andres Felipe Cristancho
